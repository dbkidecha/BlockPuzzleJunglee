...
public class LevelMaker : BaseController {
    ...
    public List<Block> listSlots = new List<Block>();
    public List<Block> listExtraTile = new List<Block>();

    public bool doneGeneratePieces;

    private string piecesResult = "";
    private List<List<Block>> pieces = new List<List<Block>>();
    ...
    public void OnLoadClick()
    {
        ...
        {
#if UNITY_EDITOR
            string folderPath = "Assets/_BlockPuzzleJunglee/Resources/Levels/World_" + world;
            if (!AssetDatabase.IsValidFolder(folderPath))
                AssetDatabase.CreateFolder("Assets/_BlockPuzzleJunglee/Resources/Levels", "World_" + world);
    ...
    private void LoadListSlots()
    {
        ...
        {
            Block tile = slot.GetComponent<Block>();
			if (tile.isActive && tile.type == Block.Type.Background) listSlots.Add(tile);
        }
    }
    ...
    {
        List<Block> piece = new List<Block>();
    ...
    private bool HasElement(Block element)
    {
    ...
    {
        return "Assets/_BlockPuzzleJunglee/Resources/Levels/World_" + world + "/Level_" + level + ".asset";
    }
}
